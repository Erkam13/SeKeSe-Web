...
export const blogs: BlogItem[] = [
  ...
  {
    id: "b-4",
    slug: "surdurulebilirlik-ve-cocuklar",
    image: foto1,
    title: "Sürdürülebilirlik ve Çocuklar",
    category: "Çevre",
    author: "Elif Kaya",
    date: "10 Ağustos 2025",
    description: "Çocuklara sürdürülebilirlik bilincinin kazandırılması ve çevre eğitimi üzerine bir makale.",
    contentHtml: `
      <p>Çocuklara erken yaşta çevre bilinci aşılamak, geleceğin daha yeşil ve sürdürülebilir olmasını sağlar.
      Oyun ve etkinliklerle öğrenme, bu bilincin kalıcı olmasını destekler.</p>
      <h2>Yöntemler</h2>
      <ul>
        <li>Doğa yürüyüşleri ve gözlemler</li>
        <li>Geri dönüşüm projeleri</li>
        <li>Bahçe işleri ve bitki yetiştirme</li>
      </ul>
      <p>Bu tür aktiviteler, çocukların çevreye olan bağlılığını artırır ve sürdürülebilir alışkanlıklar kazandırır.</p>
    `,
  }
];
